...
/**
 * <p>Clase Java para consultarOrdenesPorCliente complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarOrdenesPorCliente"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarOrdenesPorCliente", propOrder = {
    "filtro"
})
public class ConsultarOrdenesPorCliente {
