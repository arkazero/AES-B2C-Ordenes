...
/**
 * <p>Clase Java para actualizarStatusOrden complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="actualizarStatusOrden"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "actualizarStatusOrden", propOrder = {
    "solicitudActualizacion"
})
public class ActualizarStatusOrden {
